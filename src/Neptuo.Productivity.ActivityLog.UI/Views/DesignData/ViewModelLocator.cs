    ...
    internal class ViewModelLocator
    {
        ...
        public static ConfigurationViewModel Configuration
        {
            get
            {
                ...
                {
                    configuration = new ConfigurationViewModel(new Navigator(), Settings.Default, new NavigationContext<bool>());
        ...
        public static CategoryEditViewModel CategoryEdit
        {
            get
            {
                ...
                {
                    categoryEdit = new CategoryEditViewModel(new NavigationContext<ICategory>())
                    {
                        Color = Colors.Red,
                        Name = "Work"
                    };
        ...
        private static CategorySummaryViewModel categorySummary;

        public static CategorySummaryViewModel CategorySummary
        {
            get
            {
